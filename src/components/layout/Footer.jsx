  ...
  return (
    <footer className="relative border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        {/* Social + Copyright */}
        <div className="mt-14 pt-8 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between gap-6">
          {/* Social icons */}
          <div className="flex items-center gap-3">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/mr_sat_oficiall/"
              target="_blank"
            ...
            {/* Facebook */}
            <a
              href="https://web.facebook.com/profile.php?id=61583364812006"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-white/[0.06] flex items-center justify-center text-white/25 hover:text-white/60 hover:border-white/15 transition-all duration-300"
              aria-label="Facebook"
            ...
            {/* TikTok */}
            <a
              href="https://www.tiktok.com/@mrsat.oficial"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-white/[0.06] flex items-center justify-center text-white/25 hover:text-white/60 hover:border-white/15 transition-all duration-300"
              aria-label="TikTok"
            ...
            {/* Email */}
            <a
              href="mailto:comercial@soingtel.com"
              className="w-9 h-9 rounded-full border border-white/[0.06] flex items-center justify-center text-white/25 hover:text-white/60 hover:border-white/15 transition-all duration-300"
              aria-label="Email"
            >
          ...
          <p className="text-[11px] text-white/15 tracking-wide">
            © {year} Starlink Academy MR SAT. No afiliado a SpaceX o Starlink.
          </p>
        </div>
      </div>
    </footer>
